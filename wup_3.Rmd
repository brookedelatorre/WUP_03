...
The p-value is less than .05 so we reject the null hypothesis that there is no correlation between the difference in the average mean alcohol consumption based on seating location.
